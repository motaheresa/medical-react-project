    ...
    return (
        <div>
            ...
            <div className='py-10 bg-white w-full lg:w-3/6 md:w-4/6 rounded-3xl shadow-2xl mx-auto flex flex-col justify-center items-center'>
                    ...
                    <input type="text" className='my-2 border-2 px-3 w-11/12 md:w-3/4 rounded-lg outline-none py-3' placeholder='UserName' />
                    <input type="password" className=' border-2 px-3 w-11/12 md:w-3/4 rounded-lg outline-none py-3' placeholder='Password' name="" id="" />
