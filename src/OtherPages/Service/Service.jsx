...
const Services = () => {
    return (
        <>
            <HeaderForPages name="Services" />
            <div className="services py-8 md:py-12">
                <div className="section-services flex justify-center flex-wrap gap-5 items-center">
                    <div className={`slider_services lg:w-3/12 md:w-5/12 flex justify-center items-center`}>
                        <div className="slider-services-div duration-500 mx-2  shadow-2xl px-8 w-full h-96 flex flex-col  justify-center rounded-xl bg-white shadow-2xl ">
                            <p className="duration-500  svg-slider p-6 rounded-2xl border w-min">
                                <div>
                                    <svg
                            ...
                            <h2 className="services_slider_h2 text-2xl my-4 font-semibold">
                                Diagnostics
                            </h2>
                            <p className="services-slider-text">
                                Phasellus venenatis porta rhoncus. Integer et viverra felis.
                            </p>
                            <button className="mt-4 px-7 py-3 rounded-lg font-semibold services-show_more">
                                View More
                            </button>
                        </div>
                    </div>
