...
import './About.css'
import image1 from '../../assests/Page2/doc2.jpg'
import image2 from '../../assests/Page2/doc3.jpg'
import image3 from '../../assests/Page2/doc4.jpg'
import image4 from '../../assests/Page 1/square.png'
import image5 from '../../assests/Page2/Square.png'
const About = () => {
    return (
        <div className='About relative'>
            <img src={image4} className='image_four absolute left-5 bottom-4' alt="" />
            <img src={image4} className='image_five absolute right-2/4 bottom-4' alt="" />
            <div className="About-section flex lg:flex-row flex-col items-center justify-center py-24">
                <div className="About-section-left w-full relative flex flex-wrap gap-2 sm:gap-10 justify-center items-center flex-1">
                    <img src={image2} alt="" className='second_image' />
                    <img src={image1} alt="" className='first_image' />
                    <img src={image3} alt="" className='third_image' />
                    <div className='div-about flex flex-col justify-center items-center gap-4 px-10  py-10 bg-gray-300'>
                        <span className='span_about block text-center text-9xl font-bold'>
                            20
                        </span>
                        <span className='span_year font-semibold'>
                            Year Experience
                        </span>
                    </div>
                </div>
                <div className="About-section-right flex-col  lg:self-start my-6 flex-1">
                    <div className='w-5/6'>
                        <p className='about-head text-xl font-bold w-max px-3 py-1'>About Us</p>
                        <h2 className='about_header text-4xl lg:text-5xl font-semibold my-5'>The Great Place Of Medical Hospital Center</h2>
                        <p className='paragraph_header text-gray-500'>We provide the special tips and advice’s of heath care treatment
                            and high level of best technology involve in the our hospital.
                        </p>
                    </div>
                    <div className='as flex justify-left gap-10 my-14 items-center flex-wrap'>
                        <div className='as flex flex-col gap-5 items-center'>
                            <div className='help w-72 rounded-lg px-3 py-2  flex items-center gap-7 bg-transparent'>
                                <svg className=' h-full' enable-background="new 0 0 512 512" height="auto" viewBox="0 0 512 512" width="45"
                    ...
                    <button className=' hover:opacity-70 duration-500 btn_about px-7 shadow-2xl py-3 rounded-lg text-white'>Read More</button>
                </div>
                <img src={image5} className='image5about absolute bottom-10 right-10' alt="" />
            </div>
        </div>
    )
}
