...
import image1 from "../../assests/Page3/client5.jpg";
import image2 from "../../assests/Page3/client6.jpg";
import image3 from "../../assests/Page3/client7.jpg";
import image4 from "../../assests/Page3/client8.jpg";
import image5 from "../../assests/Page3/client9.jpg";
import image6 from "../../assests/Page3/client10.jpg";
import "./Services.css";
...
function UncontrolledExample() {
    ...
    useEffect(() => {
        console.log(userefhook.current);
        setWidth(userefhook.current.scrollWidth - userefhook.current.offsetWidth);
    }, []);
    return (
        <motion.div
            ref={userefhook}
            className="carousel rounded-3xl p-5 bg-blue-600"
        >
            <motion.div
                drag="x"
                dragConstraints={{ right: 0, left: -width }}
                className="mx-5 inner-carousel"
            >
                <motion.div className="feature-box-xl rounded-lg ite shadow-xl bg-white">
                    <div class=" px-5 mb-30 ">
                        <span class="icon-cell  ">
                            <svg className="border p-8 rounded-xl"
                        ...
                        <h2 className="text-2xl font-semibold mt-3">Diagnostics</h2>
                        <p className="text-gray-500 w-full my-4">
                            Phasellus venenatis port arhoncus. Integer et viverra felis.
                        </p>
                        <button className="bg-blue-100 px-4 py-2 text-blue-800 rounded-lg text-md">
                            View More
                        </button>
                    </div>
                </motion.div>
                ...
                <motion.div className="feature-box-xl rounded-lg ite shadow-xl bg-white">
                    <div class=" px-5 mb-30 mt-3">
                        ...
                        <h2 className="text-2xl font-semibold">Diagnostics</h2>
                        <p className="text-gray-500 w-full my-4 mt-3">
                            Phasellus venenatis port arhoncus. Integer et viverra felis.
                        </p>
                        <button className="bg-blue-100 px-4 py-2 text-blue-800 rounded-lg text-md">
                            View More
